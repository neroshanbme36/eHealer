...
class Result(models.Model):
  angry = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  disgust = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  fear = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  happy = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  neutral = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  sad = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  surprise = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  depressionLevel = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  improvementLevel = models.DecimalField(blank=False,max_digits=5, decimal_places=2)
  session = models.OneToOneField(Session, blank=False, on_delete=models.DO_NOTHING, related_name='session_results')
  appointment = models.OneToOneField(Appointment, blank=False, on_delete=models.DO_NOTHING, related_name='appoitment_results')
  client = models.ForeignKey(User,blank=False, on_delete=models.DO_NOTHING, related_name='client_results')
  therapist = models.ForeignKey(User, blank=False, on_delete=models.DO_NOTHING, related_name='therapist_results')
